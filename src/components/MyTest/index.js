...
const MyTest = () => {
    ...
    //     const element = modalViewRef.current // Chức năng như document.
    //     const modal = window.bootstrap.Modal.getOrCreateInstance(element)
    //     modal.show()
    // }
    ...
    return (
        <div className="myStyle">
            <header id="button-header" className="row">
                <div className="col-7"><h1>Users</h1></div>
                <div className="col-3">
            ...
            {/* <div id='btn-create'>
                <h3>Click vao Button de tao du ten va so dien thoai</h3>
